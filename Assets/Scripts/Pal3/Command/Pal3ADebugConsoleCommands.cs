...
namespace Pal3.Command
{
    ...
    public static class Pal3ADebugConsoleCommands
    {
        ...
        public static void SceneChangeGlobalObjectActivationState(System.String sceneObjectHashName, System.Int32 isActive)
        {
            CommandDispatcher<ICommand>.Instance.Dispatch(
                new SceneChangeGlobalObjectActivationStateCommand(sceneObjectHashName, isActive));
        }

        // <auto-generated/>
        [ConsoleMethodAttribute("SceneChangeObjectActivationState", "Execute SceneChangeObjectActivationStateCommand.")]
        public static void SceneChangeObjectActivationState(System.Int32 objectId, System.Int32 isActive)
        {
            CommandDispatcher<ICommand>.Instance.Dispatch(
                new SceneChangeObjectActivationStateCommand(objectId, isActive));
        }
