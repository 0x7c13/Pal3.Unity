...
namespace Pal3.Game.Command
{
    ...
    public static class ConsoleCommands
    {
        ...
        {
            Pal3.Instance.Execute(new SceneSaveGlobalBidirectionalPushableObjectStateCommand(cityName, sceneName, objectId, state));
        }
        ...
        {
            Pal3.Instance.Execute(new CameraMoveCommand(gameBoxXPosition, gameBoxYPosition, gameBoxZPosition, duration, curveType));
        }
        ...
        {
            Pal3.Instance.Execute(new CameraPushCommand(gameBoxDistance, duration, curveType));
        }
        ...
        {
            Pal3.Instance.Execute(new CameraRotateCommand(yaw, pitch, duration, curveType));
        }
        ...
        {
            Pal3.Instance.Execute(new FeatureEnableSwordPurifyingCommand(enable));
        }
        ...
        {
            Pal3.Instance.Execute(new FeatureEnableSwordSkillCommand(enable));
        }
        ...
        {
            Pal3.Instance.Execute(new LongKuiSwitchModeCommand(mode));
        }
        ...
        {
            Pal3.Instance.Execute(new MiniGamePawnshopShowNoteCommand(note));
        }
        ...
        {
            Pal3.Instance.Execute(new MiniGameStartAppraisalsCommand());
        }
        ...
        {
            Pal3.Instance.Execute(new MiniGameStartCaveExperienceCommand());
        }
        ...
        {
            Pal3.Instance.Execute(new MiniGameStartEncampCommand(flag));
        }
        ...
        {
            Pal3.Instance.Execute(new MiniGameStartHideFightCommand());
        }
        ...
        {
            Pal3.Instance.Execute(new MiniGameStartPawnshopCommand(scriptId));
        }
        ...
        {
            Pal3.Instance.Execute(new MiniGameStartSailingCommand(startSegment, endScriptId));
        }
        ...
        {
            Pal3.Instance.Execute(new MiniGameStartSkiCommand(endGameScriptId));
        }
        ...
        {
            Pal3.Instance.Execute(new MiniGameStartSwatAFlyCommand());
        }
        ...
        {
            Pal3.Instance.Execute(new PlayerSetActorLevelCommand(actorId, levelIncrease));
        }
        ...
        {
            Pal3.Instance.Execute(new SceneInitDivineTreeFlowerCommand());
        }
        ...
        {
            Pal3.Instance.Execute(new SceneRotateWorldCommand(xDegrees, yDegrees, zDegrees));
        }
        ...
        {
            Pal3.Instance.Execute(new SceneRotateWorldInverseCommand(xDegrees, yDegrees, zDegrees));
        }
        ...
        {
            Pal3.Instance.Execute(new ScriptVarSetAppraisalsResultCommand(variable));
        }
        ...
        {
            Pal3.Instance.Execute(new ScriptVarSetLongKuiDressIdCommand(variable));
        }
        ...
        {
            Pal3.Instance.Execute(new ScriptVarSetPawnshopAccrualTypeCommand(variable));
        }
        ...
        {
            Pal3.Instance.Execute(new ScriptVarSetPawnshopLevelCommand(variable));
        }
        ...
        {
            Pal3.Instance.Execute(new ScriptVarSetPawnshopManageTypeCommand(variable));
        }
        ...
        {
            Pal3.Instance.Execute(new ScriptVarSetPawnshopPeriodTypeCommand(variable));
        }
        ...
        {
            Pal3.Instance.Execute(new ScriptVarSetPawnshopUnHockTypeCommand(variable));
        }
        ...
        {
            Pal3.Instance.Execute(new UIDisplayCaptionCommand(textureName, numberOfLines));
        }
        ...
        {
            Pal3.Instance.Execute(new UIDisplayXueJianPictureCommand());
        }
