...
namespace Pal3.Command
{
    ...
    public static class Pal3DebugConsoleCommands
    {
        ...
        // <auto-generated/>
        [ConsoleMethodAttribute("CameraMove", "镜头当前位置移动（保持当前角度），参数：X，Y，Z，动作时间，插值类型")]
        public static void CameraMove(System.Single x, System.Single y, System.Single z, System.Single duration, System.Int32 mode)
        {
            CommandDispatcher<ICommand>.Instance.Dispatch(
                new CameraMoveCommand(x, y, z, duration, mode));
        }
        ...
        // <auto-generated/>
        [ConsoleMethodAttribute("CameraPush", "镜头推动作，参数：最后from与lookAt之间的距离，动作时间，插值类型（0：Linear，1：Sine）")]
        public static void CameraPush(System.Single distance, System.Single duration, System.Int32 curveType)
        {
            CommandDispatcher<ICommand>.Instance.Dispatch(
                new CameraPushCommand(distance, duration, curveType));
        }
        ...
        // <auto-generated/>
        [ConsoleMethodAttribute("FlyingActorFlyTo", "让花盈飞到某空间点参数：X，Y，Z")]
        ...
        public static void SceneRotateWorld(System.Int32 x, System.Int32 y, System.Int32 z)
        {
            CommandDispatcher<ICommand>.Instance.Dispatch(
                new SceneRotateWorldCommand(x, y, z));
        }
