...
namespace Pal3.Command
{
    ...
    public static class ConsoleCommands
    {
        ...
        {
            CommandDispatcher<ICommand>.Instance.Dispatch(
                new CombatEnterBossFightUsingMusicWithSpecialActorCommand(monster1Id, monster2Id, monster3Id, monster4Id, monster5Id, monster6Id, combatMusicName, combatCommandId));
        }
        ...
        // <auto-generated/>
        [ConsoleMethodAttribute("ScriptGetWheelOfTheFiveElementsUsageCount", "取出五灵轮当前使用次数并赋值给变量，参数：变量名")]
        public static void ScriptGetWheelOfTheFiveElementsUsageCount(System.Int32 variable)
        {
            CommandDispatcher<ICommand>.Instance.Dispatch(
                new ScriptGetWheelOfTheFiveElementsUsageCountCommand(variable));
        }
