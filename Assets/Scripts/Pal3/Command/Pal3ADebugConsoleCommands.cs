...
namespace Pal3.Command
{
    ...
    public static class Pal3ADebugConsoleCommands
    {
        ...
        // <auto-generated/>
        [ConsoleMethodAttribute("NavigationBeeFlyTo", "控制引路蜂飞向指定位置参数：Nav层，TileMap中X坐标，TileMap中Z坐标")]
        public static void NavigationBeeFlyTo(System.Int32 navLayerIndex, System.Int32 tileXPosition, System.Int32 tileZPosition)
        {
            CommandDispatcher<ICommand>.Instance.Dispatch(
                new NavigationBeeFlyToCommand(navLayerIndex, tileXPosition, tileZPosition));
        }
        ...
        public static void SceneChangeGlobalObjectActivationState(System.String sceneObjectHashName, System.Boolean isEnabled)
        {
            CommandDispatcher<ICommand>.Instance.Dispatch(
                new SceneChangeGlobalObjectActivationStateCommand(sceneObjectHashName, isEnabled));
        }

        // <auto-generated/>
        [ConsoleMethodAttribute("SceneChangeObjectActivationState", "Execute SceneChangeObjectActivationStateCommand.")]
        public static void SceneChangeObjectActivationState(System.Int32 objectId, System.Boolean isEnabled)
        {
            CommandDispatcher<ICommand>.Instance.Dispatch(
                new SceneChangeObjectActivationStateCommand(objectId, isEnabled));
        }
